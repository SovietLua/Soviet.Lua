...
local Environment = getgenv().SovietLua
...
function Environment.Blacklist(self, Username) -- METHOD | SovietLua:Blacklist(<string> Player Name)
	assert(self, "SOVIET_AIMBOT-V3.Blacklist: Missing parameter #1 \"self\" <table>.")
	assert(Username, "SOVIET_AIMBOT-V3.Blacklist: Missing parameter #2 \"Username\" <string>.")

	Username = FixUsername(Username)

	assert(self, "SOVIET_AIMBOT-V3.Blacklist: User "..Username.." couldn't be found.")

	self.Blacklisted[#self.Blacklisted + 1] = Username
end

function Environment.Whitelist(self, Username) -- METHOD | SovietLua:Whitelist(<string> Player Name)
	assert(self, "SOVIET_AIMBOT-V3.Whitelist: Missing parameter #1 \"self\" <table>.")
	assert(Username, "SOVIET_AIMBOT-V3.Whitelist: Missing parameter #2 \"Username\" <string>.")

	Username = FixUsername(Username)

	assert(Username, "SOVIET_AIMBOT-V3.Whitelist: User "..Username.." couldn't be found.")

	local Index = tablefind(self.Blacklisted, Username)

	assert(Index, "SOVIET_AIMBOT-V3.Whitelist: User "..Username.." is not blacklisted.")

	tableremove(self.Blacklisted, Index)
end

function Environment.GetClosestPlayer() -- SovietLua.GetClosestPlayer(<void>)
	GetClosestPlayer()
...
Environment.Load = Load -- SovietLua.Load()
